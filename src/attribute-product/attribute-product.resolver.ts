...
export class AttributeProductResolver {
  constructor(private readonly attributeProductService: AttributeProductService) {}

  @Mutation(() => AttributeProduct)
  createAttributeProduct(@Args('createAttributeProductInput') createAttributeProductInput: CreateAttributeProductInput) {
  ...
  @Mutation(() => AttributeProduct)
  updateAttributeProduct(@Args('updateAttributeProductInput') updateAttributeProductInput: UpdateAttributeProductInput) {
    return this.attributeProductService.update(updateAttributeProductInput.id, updateAttributeProductInput);
  }
