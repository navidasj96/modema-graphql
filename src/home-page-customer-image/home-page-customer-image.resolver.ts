...
export class HomePageCustomerImageResolver {
  constructor(private readonly homePageCustomerImageService: HomePageCustomerImageService) {}

  @Mutation(() => HomePageCustomerImage)
  createHomePageCustomerImage(@Args('createHomePageCustomerImageInput') createHomePageCustomerImageInput: CreateHomePageCustomerImageInput) {
    return this.homePageCustomerImageService.create(createHomePageCustomerImageInput);
  }
  ...
  @Mutation(() => HomePageCustomerImage)
  updateHomePageCustomerImage(@Args('updateHomePageCustomerImageInput') updateHomePageCustomerImageInput: UpdateHomePageCustomerImageInput) {
    return this.homePageCustomerImageService.update(updateHomePageCustomerImageInput.id, updateHomePageCustomerImageInput);
  }
