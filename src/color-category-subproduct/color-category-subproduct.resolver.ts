...
export class ColorCategorySubproductResolver {
  constructor(private readonly colorCategorySubproductService: ColorCategorySubproductService) {}

  @Mutation(() => ColorCategorySubproduct)
  createColorCategorySubproduct(@Args('createColorCategorySubproductInput') createColorCategorySubproductInput: CreateColorCategorySubproductInput) {
    return this.colorCategorySubproductService.create(createColorCategorySubproductInput);
  }
  ...
  @Mutation(() => ColorCategorySubproduct)
  updateColorCategorySubproduct(@Args('updateColorCategorySubproductInput') updateColorCategorySubproductInput: UpdateColorCategorySubproductInput) {
    return this.colorCategorySubproductService.update(updateColorCategorySubproductInput.id, updateColorCategorySubproductInput);
  }
