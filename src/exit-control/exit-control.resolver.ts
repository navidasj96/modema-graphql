...
export class ExitControlResolver {
  ...
  createExitControl(@Args('createExitControlInput') createExitControlInput: CreateExitControlInput) {
  ...
  @Mutation(() => ExitControl)
  updateExitControl(@Args('updateExitControlInput') updateExitControlInput: UpdateExitControlInput) {
    return this.exitControlService.update(updateExitControlInput.id, updateExitControlInput);
  }
