...
export class BasicCarpetSizeResolver {
  constructor(private readonly basicCarpetSizeService: BasicCarpetSizeService) {}

  @Mutation(() => BasicCarpetSize)
  createBasicCarpetSize(@Args('createBasicCarpetSizeInput') createBasicCarpetSizeInput: CreateBasicCarpetSizeInput) {
  ...
  @Mutation(() => BasicCarpetSize)
  updateBasicCarpetSize(@Args('updateBasicCarpetSizeInput') updateBasicCarpetSizeInput: UpdateBasicCarpetSizeInput) {
    return this.basicCarpetSizeService.update(updateBasicCarpetSizeInput.id, updateBasicCarpetSizeInput);
  }
