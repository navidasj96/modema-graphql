...
export class HeardAboutUsOptionResolver {
  constructor(private readonly heardAboutUsOptionService: HeardAboutUsOptionService) {}

  @Mutation(() => HeardAboutUsOption)
  createHeardAboutUsOption(@Args('createHeardAboutUsOptionInput') createHeardAboutUsOptionInput: CreateHeardAboutUsOptionInput) {
  ...
  @Mutation(() => HeardAboutUsOption)
  updateHeardAboutUsOption(@Args('updateHeardAboutUsOptionInput') updateHeardAboutUsOptionInput: UpdateHeardAboutUsOptionInput) {
    return this.heardAboutUsOptionService.update(updateHeardAboutUsOptionInput.id, updateHeardAboutUsOptionInput);
  }
