...
export class FileNegotiationResolver {
  constructor(private readonly fileNegotiationService: FileNegotiationService) {}

  @Mutation(() => FileNegotiation)
  createFileNegotiation(@Args('createFileNegotiationInput') createFileNegotiationInput: CreateFileNegotiationInput) {
  ...
  @Mutation(() => FileNegotiation)
  updateFileNegotiation(@Args('updateFileNegotiationInput') updateFileNegotiationInput: UpdateFileNegotiationInput) {
    return this.fileNegotiationService.update(updateFileNegotiationInput.id, updateFileNegotiationInput);
  }
