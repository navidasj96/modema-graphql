...
export class ChaparTrackingHistoryResolver {
  constructor(private readonly chaparTrackingHistoryService: ChaparTrackingHistoryService) {}

  @Mutation(() => ChaparTrackingHistory)
  createChaparTrackingHistory(@Args('createChaparTrackingHistoryInput') createChaparTrackingHistoryInput: CreateChaparTrackingHistoryInput) {
    return this.chaparTrackingHistoryService.create(createChaparTrackingHistoryInput);
  }
  ...
  @Mutation(() => ChaparTrackingHistory)
  updateChaparTrackingHistory(@Args('updateChaparTrackingHistoryInput') updateChaparTrackingHistoryInput: UpdateChaparTrackingHistoryInput) {
    return this.chaparTrackingHistoryService.update(updateChaparTrackingHistoryInput.id, updateChaparTrackingHistoryInput);
  }
