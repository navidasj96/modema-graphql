...
export class CustomerRequestFileResolver {
  constructor(private readonly customerRequestFileService: CustomerRequestFileService) {}

  @Mutation(() => CustomerRequestFile)
  createCustomerRequestFile(@Args('createCustomerRequestFileInput') createCustomerRequestFileInput: CreateCustomerRequestFileInput) {
    return this.customerRequestFileService.create(createCustomerRequestFileInput);
  }
  ...
  @Mutation(() => CustomerRequestFile)
  updateCustomerRequestFile(@Args('updateCustomerRequestFileInput') updateCustomerRequestFileInput: UpdateCustomerRequestFileInput) {
    return this.customerRequestFileService.update(updateCustomerRequestFileInput.id, updateCustomerRequestFileInput);
  }
