...
export class HyperstarCodeResolver {
  ...
  createHyperstarCode(@Args('createHyperstarCodeInput') createHyperstarCodeInput: CreateHyperstarCodeInput) {
  ...
  @Mutation(() => HyperstarCode)
  updateHyperstarCode(@Args('updateHyperstarCodeInput') updateHyperstarCodeInput: UpdateHyperstarCodeInput) {
    return this.hyperstarCodeService.update(updateHyperstarCodeInput.id, updateHyperstarCodeInput);
  }
