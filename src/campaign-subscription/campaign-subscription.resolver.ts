...
export class CampaignSubscriptionResolver {
  constructor(private readonly campaignSubscriptionService: CampaignSubscriptionService) {}

  @Mutation(() => CampaignSubscription)
  createCampaignSubscription(@Args('createCampaignSubscriptionInput') createCampaignSubscriptionInput: CreateCampaignSubscriptionInput) {
    return this.campaignSubscriptionService.create(createCampaignSubscriptionInput);
  }
  ...
  @Mutation(() => CampaignSubscription)
  updateCampaignSubscription(@Args('updateCampaignSubscriptionInput') updateCampaignSubscriptionInput: UpdateCampaignSubscriptionInput) {
    return this.campaignSubscriptionService.update(updateCampaignSubscriptionInput.id, updateCampaignSubscriptionInput);
  }
