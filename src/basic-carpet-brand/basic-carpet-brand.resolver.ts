...
export class BasicCarpetBrandResolver {
  constructor(private readonly basicCarpetBrandService: BasicCarpetBrandService) {}

  @Mutation(() => BasicCarpetBrand)
  createBasicCarpetBrand(@Args('createBasicCarpetBrandInput') createBasicCarpetBrandInput: CreateBasicCarpetBrandInput) {
  ...
  @Mutation(() => BasicCarpetBrand)
  updateBasicCarpetBrand(@Args('updateBasicCarpetBrandInput') updateBasicCarpetBrandInput: UpdateBasicCarpetBrandInput) {
    return this.basicCarpetBrandService.update(updateBasicCarpetBrandInput.id, updateBasicCarpetBrandInput);
  }
