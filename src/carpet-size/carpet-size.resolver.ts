...
export class CarpetSizeResolver {
  ...
  @Mutation(() => CarpetSize)
  createCarpetSize(@Args('createCarpetSizeInput') createCarpetSizeInput: CreateCarpetSizeInput) {
  ...
  @Mutation(() => CarpetSize)
  updateCarpetSize(@Args('updateCarpetSizeInput') updateCarpetSizeInput: UpdateCarpetSizeInput) {
    return this.carpetSizeService.update(updateCarpetSizeInput.id, updateCarpetSizeInput);
  }
