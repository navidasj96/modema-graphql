...
export class CarpetMaterialResolver {
  ...
  createCarpetMaterial(@Args('createCarpetMaterialInput') createCarpetMaterialInput: CreateCarpetMaterialInput) {
  ...
  @Mutation(() => CarpetMaterial)
  updateCarpetMaterial(@Args('updateCarpetMaterialInput') updateCarpetMaterialInput: UpdateCarpetMaterialInput) {
    return this.carpetMaterialService.update(updateCarpetMaterialInput.id, updateCarpetMaterialInput);
  }
