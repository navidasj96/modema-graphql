...
export class BasicCarpetBorderResolver {
  constructor(private readonly basicCarpetBorderService: BasicCarpetBorderService) {}

  @Mutation(() => BasicCarpetBorder)
  createBasicCarpetBorder(@Args('createBasicCarpetBorderInput') createBasicCarpetBorderInput: CreateBasicCarpetBorderInput) {
  ...
  @Mutation(() => BasicCarpetBorder)
  updateBasicCarpetBorder(@Args('updateBasicCarpetBorderInput') updateBasicCarpetBorderInput: UpdateBasicCarpetBorderInput) {
    return this.basicCarpetBorderService.update(updateBasicCarpetBorderInput.id, updateBasicCarpetBorderInput);
  }
