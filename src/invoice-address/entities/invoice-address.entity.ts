...
export class InvoiceAddress {
  ...
  @ManyToOne(() => Addresses, (addresses) => addresses.invoiceAddresses, {
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  })
  ...
  @ManyToOne(() => Cities, (cities) => cities.invoiceAddresses, {
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  })
  ...
  @ManyToOne(() => Countries, (countries) => countries.invoiceAddresses, {
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  })
  ...
  @ManyToOne(() => Invoices, (invoices) => invoices.invoiceAddresses, {
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  })
  ...
  @ManyToOne(() => States, (states) => states.invoiceAddresses, {
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  })
  ...
  @ManyToOne(() => Users, (users) => users.invoiceAddresses, {
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  })
  ...
  @OneToMany(
    () => InvoiceHistories,
    (invoiceHistories) => invoiceHistories.invoiceAddress,
  )
