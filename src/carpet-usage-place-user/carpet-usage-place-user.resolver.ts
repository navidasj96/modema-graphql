...
export class CarpetUsagePlaceUserResolver {
  constructor(private readonly carpetUsagePlaceUserService: CarpetUsagePlaceUserService) {}

  @Mutation(() => CarpetUsagePlaceUser)
  createCarpetUsagePlaceUser(@Args('createCarpetUsagePlaceUserInput') createCarpetUsagePlaceUserInput: CreateCarpetUsagePlaceUserInput) {
    return this.carpetUsagePlaceUserService.create(createCarpetUsagePlaceUserInput);
  }
  ...
  @Mutation(() => CarpetUsagePlaceUser)
  updateCarpetUsagePlaceUser(@Args('updateCarpetUsagePlaceUserInput') updateCarpetUsagePlaceUserInput: UpdateCarpetUsagePlaceUserInput) {
    return this.carpetUsagePlaceUserService.update(updateCarpetUsagePlaceUserInput.id, updateCarpetUsagePlaceUserInput);
  }
