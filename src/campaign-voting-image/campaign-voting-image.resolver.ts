...
export class CampaignVotingImageResolver {
  constructor(private readonly campaignVotingImageService: CampaignVotingImageService) {}

  @Mutation(() => CampaignVotingImage)
  createCampaignVotingImage(@Args('createCampaignVotingImageInput') createCampaignVotingImageInput: CreateCampaignVotingImageInput) {
    return this.campaignVotingImageService.create(createCampaignVotingImageInput);
  }
  ...
  @Mutation(() => CampaignVotingImage)
  updateCampaignVotingImage(@Args('updateCampaignVotingImageInput') updateCampaignVotingImageInput: UpdateCampaignVotingImageInput) {
    return this.campaignVotingImageService.update(updateCampaignVotingImageInput.id, updateCampaignVotingImageInput);
  }
