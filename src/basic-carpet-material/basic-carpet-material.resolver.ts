...
export class BasicCarpetMaterialResolver {
  constructor(private readonly basicCarpetMaterialService: BasicCarpetMaterialService) {}

  @Mutation(() => BasicCarpetMaterial)
  createBasicCarpetMaterial(@Args('createBasicCarpetMaterialInput') createBasicCarpetMaterialInput: CreateBasicCarpetMaterialInput) {
    return this.basicCarpetMaterialService.create(createBasicCarpetMaterialInput);
  }
  ...
  @Mutation(() => BasicCarpetMaterial)
  updateBasicCarpetMaterial(@Args('updateBasicCarpetMaterialInput') updateBasicCarpetMaterialInput: UpdateBasicCarpetMaterialInput) {
    return this.basicCarpetMaterialService.update(updateBasicCarpetMaterialInput.id, updateBasicCarpetMaterialInput);
  }
