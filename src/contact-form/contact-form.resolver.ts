...
export class ContactFormResolver {
  ...
  createContactForm(@Args('createContactFormInput') createContactFormInput: CreateContactFormInput) {
  ...
  @Mutation(() => ContactForm)
  updateContactForm(@Args('updateContactFormInput') updateContactFormInput: UpdateContactFormInput) {
    return this.contactFormService.update(updateContactFormInput.id, updateContactFormInput);
  }
