...
export class CampaignFreeOfferResolver {
  constructor(private readonly campaignFreeOfferService: CampaignFreeOfferService) {}

  @Mutation(() => CampaignFreeOffer)
  createCampaignFreeOffer(@Args('createCampaignFreeOfferInput') createCampaignFreeOfferInput: CreateCampaignFreeOfferInput) {
  ...
  @Mutation(() => CampaignFreeOffer)
  updateCampaignFreeOffer(@Args('updateCampaignFreeOfferInput') updateCampaignFreeOfferInput: UpdateCampaignFreeOfferInput) {
    return this.campaignFreeOfferService.update(updateCampaignFreeOfferInput.id, updateCampaignFreeOfferInput);
  }
