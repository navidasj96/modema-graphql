...
export class InvoicePayment {
  ...
  @OneToMany(
    ...
    (invoicePaymentHistories) => invoicePaymentHistories.invoicePayment,
  )
  invoicePaymentHistories: InvoicePaymentHistories[];

  @ManyToOne(() => Users, (users) => users.invoicePayments, {
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  })
  ...
  @ManyToOne(() => Invoices, (invoices) => invoices.invoicePayments, {
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  })
