...
export class BasicCarpetTypeResolver {
  constructor(private readonly basicCarpetTypeService: BasicCarpetTypeService) {}

  @Mutation(() => BasicCarpetType)
  createBasicCarpetType(@Args('createBasicCarpetTypeInput') createBasicCarpetTypeInput: CreateBasicCarpetTypeInput) {
  ...
  @Mutation(() => BasicCarpetType)
  updateBasicCarpetType(@Args('updateBasicCarpetTypeInput') updateBasicCarpetTypeInput: UpdateBasicCarpetTypeInput) {
    return this.basicCarpetTypeService.update(updateBasicCarpetTypeInput.id, updateBasicCarpetTypeInput);
  }
