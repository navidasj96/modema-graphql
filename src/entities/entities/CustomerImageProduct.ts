...
@Entity("customer_image_product", { schema: "mydatabase" })
export class CustomerImageProduct {
  ...
  @ManyToOne(() => Images, (images) => images.customerImageProducts, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
  ...
  @ManyToOne(() => Products, (products) => products.customerImageProducts, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
