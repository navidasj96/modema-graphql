...
export class IncredibleOffers {
  ...
  @ManyToOne(
    () => BasicCarpetColors,
    (basicCarpetColors) => basicCarpetColors.incredibleOffers,
    { onDelete: "NO ACTION", onUpdate: "NO ACTION" }
  )
  @JoinColumn([{ name: "basic_carpet_color_id", referencedColumnName: "id" }])
  basicCarpetColor: BasicCarpetColors;

  @ManyToOne(() => Discounts, (discounts) => discounts.incredibleOffers, {
    onDelete: "CASCADE",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => Products, (products) => products.incredibleOffers, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
