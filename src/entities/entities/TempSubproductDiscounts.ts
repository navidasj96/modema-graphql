...
export class TempSubproductDiscounts {
  ...
  subproductDiscountId: number | null;
  ...
  priceMinusDiscount: string | null;
  ...
  padPriceMinusDiscount: string | null;
  ...
  padDiscountPercent: number | null;
