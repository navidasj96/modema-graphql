...
export class InvoiceProducts {
  ...
  @OneToMany(
    ...
    (invoiceProductHistories) => invoiceProductHistories.invoiceProduct
  )
  ...
  @OneToMany(
    ...
    (invoiceReversalItems) => invoiceReversalItems.invoiceProduct
  )
  invoiceReversalItems: InvoiceReversalItems[];

  @OneToMany(
    () => ReturnRequestItemHistories,
    (returnRequestItemHistories) => returnRequestItemHistories.invoiceProduct
  )
  returnRequestItemHistories: ReturnRequestItemHistories[];

  @OneToMany(
    () => ReturnRequestItems,
    (returnRequestItems) => returnRequestItems.invoiceProduct
  )
  returnRequestItems: ReturnRequestItems[];

  @OneToMany(
    () => ReturnedInvoiceProducts,
    (returnedInvoiceProducts) => returnedInvoiceProducts.invoiceProduct
  )
  returnedInvoiceProducts: ReturnedInvoiceProducts[];

  @OneToMany(
    () => SubproductStockHistories,
    (subproductStockHistories) => subproductStockHistories.invoiceProduct
  )
