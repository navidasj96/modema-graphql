...
export class CampaignVotingImageUserResolver {
  constructor(private readonly campaignVotingImageUserService: CampaignVotingImageUserService) {}

  @Mutation(() => CampaignVotingImageUser)
  createCampaignVotingImageUser(@Args('createCampaignVotingImageUserInput') createCampaignVotingImageUserInput: CreateCampaignVotingImageUserInput) {
    return this.campaignVotingImageUserService.create(createCampaignVotingImageUserInput);
  }
  ...
  @Mutation(() => CampaignVotingImageUser)
  updateCampaignVotingImageUser(@Args('updateCampaignVotingImageUserInput') updateCampaignVotingImageUserInput: UpdateCampaignVotingImageUserInput) {
    return this.campaignVotingImageUserService.update(updateCampaignVotingImageUserInput.id, updateCampaignVotingImageUserInput);
  }
