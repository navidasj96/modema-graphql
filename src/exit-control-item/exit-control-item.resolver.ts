...
export class ExitControlItemResolver {
  constructor(private readonly exitControlItemService: ExitControlItemService) {}

  @Mutation(() => ExitControlItem)
  createExitControlItem(@Args('createExitControlItemInput') createExitControlItemInput: CreateExitControlItemInput) {
  ...
  @Mutation(() => ExitControlItem)
  updateExitControlItem(@Args('updateExitControlItemInput') updateExitControlItemInput: UpdateExitControlItemInput) {
    return this.exitControlItemService.update(updateExitControlItemInput.id, updateExitControlItemInput);
  }
