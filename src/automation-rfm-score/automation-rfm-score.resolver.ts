...
export class AutomationRfmScoreResolver {
  constructor(private readonly automationRfmScoreService: AutomationRfmScoreService) {}

  @Mutation(() => AutomationRfmScore)
  createAutomationRfmScore(@Args('createAutomationRfmScoreInput') createAutomationRfmScoreInput: CreateAutomationRfmScoreInput) {
  ...
  @Mutation(() => AutomationRfmScore)
  updateAutomationRfmScore(@Args('updateAutomationRfmScoreInput') updateAutomationRfmScoreInput: UpdateAutomationRfmScoreInput) {
    return this.automationRfmScoreService.update(updateAutomationRfmScoreInput.id, updateAutomationRfmScoreInput);
  }
